 ...
 *
 * @param handle Handle to the block of memory, as given by lesp_himem_alloc
 ...
 *
 * @param handle Handle to the range block, as given by lesp_himem_alloc_map_range
 * @returns - ESP_OK if the memory is succesfully freed
 ...
 * @param ptr Pointer returned by lesp_himem_map
 ...
 */
// size_t lesp_himem_get_phys_size();
